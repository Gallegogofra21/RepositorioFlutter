...
class _SeatItemWidgetState extends State<SeatItemWidget> {
  ...
  late SeatModel _seatSelected;

  @override
  void initState() {
    super.initState();
    _seat = SeatModel(state: SeatState.pass, letter: '', row: 0);
  }
  ...
  Widget build(BuildContext context) {
    if (_seat.state == SeatState.pass) {
      ...
      return GestureDetector(
        onTap: () {
          setState(() {
            _seat.state = SeatModel(state: state, row: row, letter: letter)
            _seatSelected = _seat;
          });
                ...
                Container(
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [Icon(Icons.bed), Text('Restroom')]),
                        Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [Icon(Icons.local_bar), Text('Drinks')]),
                      ]),
                )
              ],
            ),
